...
class AlphaVantageClient:
    ...
    def get_top_gainers_losers(self) -> Dict:
        ...
        Endpoint: TOP_GAINERS_LOSERS (1 API call total, no params)
    ...
    def get_balance_sheet(self, symbol: str) -> Dict:
        """
        Get balance sheet data (quarterly and annual reports).

        Args:
            symbol: Stock ticker (e.g., 'AAPL')

        Returns:
            Dict with quarterlyReports and annualReports
        """
        params = {
    ...
    def get_cash_flow(self, symbol: str) -> Dict:
        """
        Get cash flow statement data (quarterly and annual reports).
