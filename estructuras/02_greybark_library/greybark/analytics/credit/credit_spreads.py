...
class CreditSpreadAnalytics:
    ...
    def _fetch_spread_series(self, series_id: str,
        ...
        FRED ICE BofA OAS series are in percentage points (e.g. 0.77 = 77bps).
        We convert to basis points here so all downstream consumers get bps.
        """
        try:
            ...
            if data is not None and len(data) > 0:
                data = data * 100  # Convert percentage points → basis points
            return data
