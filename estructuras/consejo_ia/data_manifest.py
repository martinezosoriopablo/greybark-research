...
MACRO_MANIFEST: List[DataField] = [
    ...
    DataField("macro_usa.fed_funds", "Fed Funds Rate", "FRED:DFF", "%", FieldPriority.REQUIRED),
    ...
    DataField("chile.ipc_yoy", "IPC Chile YoY", "BCCh:IPC", "%", FieldPriority.REQUIRED),
    # --- IMPORTANT ---
    ...
    DataField("macro_usa.nonfarm_payrolls", "ADP/NFP Employment", "FRED:PAYEMS", "K", FieldPriority.IMPORTANT),
...
RV_MANIFEST: List[DataField] = [
    ...
    DataField("macro_usa.fed_funds", "Fed Funds Rate", "FRED:DFF", "%", FieldPriority.IMPORTANT),
    # --- OPTIONAL ---
