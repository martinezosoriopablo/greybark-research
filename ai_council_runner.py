...
"""
        ...
        # Inyectar curvas soberanas si existen
        sovereign_text = agent_data.get('sovereign_curves_text', '')
        if sovereign_text:
            prompt += f"""
## CURVAS SOBERANAS (Alemania, UK, Japón — Datos en Vivo)
{sovereign_text}
"""
...
"""
        ...
        # Curvas soberanas
        sovereign_text = council_input.get('quantitative', {}).get('sovereign_curves_text', '')
        if sovereign_text:
            prompt += f"""
## CURVAS SOBERANAS (Alemania, UK, Japón — Datos en Vivo)
{sovereign_text}
