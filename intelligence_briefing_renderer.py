    ...
    def _render_sentiment_bars(self, trajectory: list) -> str:
        ...
        for week in trajectory:
            ...
            html_parts.append(
                ...
                f'<div class="bar-risk-on" style="width:{pct_on:.0f}%" title="Risk-On: postura favorable a activos de riesgo ({pct_on:.0f}%)"></div>'
                f'<div class="bar-cautious" style="width:{pct_cau:.0f}%"></div>'
                f'<div class="bar-risk-off" style="width:{pct_off:.0f}%" title="Risk-Off: postura defensiva respecto a activos de riesgo ({pct_off:.0f}%)"></div>'
                f'</div>'
